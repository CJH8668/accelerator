...
module e203_subsys_perips(
  ...
  // assign gpio_iof_0_0_o_oe         = 1'b1;

  assign gpio_iof_0_0_o_ie         = 1'b0;

  assign gpio_iof_0_0_o_valid      = 1'b0;
  // assign gpio_iof_0_0_o_valid      = 1'b1;
...
//   wire [32-1:0]            sysper_icb_cmd_addr; 
//   wire                     sysper_icb_cmd_read; 
//   wire [32-1:0]            sysper_icb_cmd_wdata;
//   wire [4 -1:0]            sysper_icb_cmd_wmask;

//   wire                     sysper_icb_rsp_valid;
//   wire                     sysper_icb_rsp_ready;
//   wire [32-1:0]            sysper_icb_rsp_rdata;
//   wire                     sysper_icb_rsp_err;
//////////////////////////////////////////////////


  // float point mul
  wire                     mul_icb_cmd_valid;
  wire                     mul_icb_cmd_ready;
  wire [32-1:0]            mul_icb_cmd_addr; 
  wire                     mul_icb_cmd_read; 
  wire [32-1:0]            mul_icb_cmd_wdata;
  wire [4 -1:0]            mul_icb_cmd_wmask;

  wire                     mul_icb_rsp_valid;
  wire                     mul_icb_rsp_ready;
  wire [32-1:0]            mul_icb_rsp_rdata;
  wire                     mul_icb_rsp_err;
  ...
  //  * flopomul  : 0x1100 0000 -- 0x11FF FFFF
...
////////////////////////////////////////////////////
  ...
  // float point mul
    ...
    .o12_icb_cmd_valid  (mul_icb_cmd_valid),
    .o12_icb_cmd_ready  (mul_icb_cmd_ready),
    .o12_icb_cmd_addr   (mul_icb_cmd_addr ),
    .o12_icb_cmd_read   (mul_icb_cmd_read ),
    .o12_icb_cmd_wdata  (mul_icb_cmd_wdata),
    .o12_icb_cmd_wmask  (mul_icb_cmd_wmask),
    .o12_icb_cmd_lock   (),
    .o12_icb_cmd_excl   (),
    .o12_icb_cmd_size   (),
    .o12_icb_cmd_burst  (),
    ...
    .o12_icb_rsp_valid  (mul_icb_rsp_valid),
    .o12_icb_rsp_ready  (mul_icb_rsp_ready),
    .o12_icb_rsp_err    (mul_icb_rsp_err),
    .o12_icb_rsp_excl_ok(1'b0  ),
    .o12_icb_rsp_rdata  (mul_icb_rsp_rdata),
...
// wire done;
// assign io_pads_gpio_0_i_ival = done;
...
/////////////////////////////////////////////////
// // here is sysperips (added perips)
// e203_subsys_addperips u_e203_subsys_addperips(
//     .clk              (clk  ),
//     .rst_n            (rst_n),
//     .bus_rst_n        (bus_rst_n),
//
//     .i_icb_cmd_valid  (sysper_icb_cmd_valid),
//     .i_icb_cmd_ready  (sysper_icb_cmd_ready),
//     .i_icb_cmd_addr   (sysper_icb_cmd_addr ),
//     .i_icb_cmd_read   (sysper_icb_cmd_read ),
//     .i_icb_cmd_wdata  (sysper_icb_cmd_wdata),
//     .i_icb_cmd_wmask  (sysper_icb_cmd_wmask),
//
//
//     .i_icb_rsp_valid  (sysper_icb_rsp_valid),
//     .i_icb_rsp_ready  (sysper_icb_rsp_ready),
//     .i_icb_rsp_err    (sysper_icb_rsp_err  ),
//     .i_icb_rsp_rdata  (sysper_icb_rsp_rdata)
//   );
/////////////////////////////////////////////////

// float point mul
multiplication_top u_multiplication_top(
    .clk              (clk  ),
    .rst_n            (rst_n),
    // .bus_rst_n        (bus_rst_n),

    .mul_icb_cmd_valid  (mul_icb_cmd_valid),
    .mul_icb_cmd_ready  (mul_icb_cmd_ready),
    .mul_icb_cmd_addr   (mul_icb_cmd_addr ),
    .mul_icb_cmd_read   (mul_icb_cmd_read ),
    .mul_icb_cmd_wdata  (mul_icb_cmd_wdata),
    // .mul_icb_cmd_wmask  (mul_icb_cmd_wmask),


    .mul_icb_rsp_valid  (mul_icb_rsp_valid),
    .mul_icb_rsp_ready  (mul_icb_rsp_ready),
    .mul_icb_rsp_err    (mul_icb_rsp_err  ),
    .mul_icb_rsp_rdata  (mul_icb_rsp_rdata)
  );
