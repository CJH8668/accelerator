...
module e203_subsys_mems(
  ...
  // wire                         rram_icb_cmd_valid;
  // wire                         rram_icb_cmd_ready;
  // wire [`E203_ADDR_SIZE-1:0]   rram_icb_cmd_addr; d
  // wire                         rram_icb_cmd_read;
  // wire [`E203_XLEN-1:0]        rram_icb_cmd_wdata;  
  // wire                         rram_icb_rsp_valid;
  // wire                         rram_icb_rsp_ready;
  // wire                         rram_icb_rsp_err  ;
  // wire [`E203_XLEN-1:0]        rram_icb_rsp_rdata;
 ...
 localparam MROM_DP = 1024;
  ...
  // * RRAM      : 0x5000_0000 -- 0x5000_7FFF 
  .O6_BASE_ADDR       (32'h5000_0000),       
  .O6_BASE_REGION_LSB (15),
...
sirv_expl_axi_slv # (
  ...
  // sirv_rram_top sirv_rram_top_u0(
  //   .rram_icb_cmd_valid     (rram_icb_cmd_valid),
  //   .rram_icb_cmd_ready     (rram_icb_cmd_ready),
  //   .rram_icb_cmd_addr      (rram_icb_cmd_addr ),
  //   .rram_icb_cmd_read      (rram_icb_cmd_read ),
  //   .rram_icb_cmd_wdata     (rram_icb_cmd_wdata),
  //   .rram_icb_rsp_valid     (rram_icb_rsp_valid),
  //   .rram_icb_rsp_ready     (rram_icb_rsp_ready),
  //   .rram_icb_rsp_err       (rram_icb_rsp_err  ),
  //   .rram_icb_rsp_rdata     (rram_icb_rsp_rdata),
